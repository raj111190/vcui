...
import { withStyles, List, ListItem, Link, ListItemIcon, IconButton, ListItemText, ListItemSecondaryAction, Divider, Grid, SvgIcon as SvgIcon$1 } from '@material-ui/core';
...
import ListItemSecondaryAction$1 from '@material-ui/core/ListItemSecondaryAction';
...
var VcButton$1 = withStyles(styles)(VcButton);
...
var ListItemLink = function ListItemLink(props) {
  ...
  return /*#__PURE__*/React.createElement(ListItem, {
    component: "div",
    className: className
  }, /*#__PURE__*/React.createElement(Link, otherProps, children));
};
...
var VcDiagnosisList = function VcDiagnosisList(props) {
  ...
  function renderDiagnosis(diagnosis) {
    ...
    }, onDelete ? /*#__PURE__*/React.createElement(ListItemIcon, {
    ...
    }))) : null, /*#__PURE__*/React.createElement(ListItemIcon, {
      className: classes.diagnosisIcon,
      style: getIconStyle(diagnosis)
    }, /*#__PURE__*/React.createElement(DiagnosisIcon, null)), diagnosis.certainty === DIAGNOSIS_CERTAINTY.CONFIRMED ? /*#__PURE__*/React.createElement(ListItemLink, {
      component: "button",
      variant: "body1",
      onClick: function onClick() {
    ...
    }), /*#__PURE__*/React.createElement(ListItemSecondaryAction, null, /*#__PURE__*/React.createElement(Link, {
      component: "button",
      className: classes.upperCase,
      onClick: function onClick() {
        return action && action(diagnosis);
      }
    }, diagnosis.certainty === DIAGNOSIS_CERTAINTY.CONFIRMED ? resolveText : confirmText))), /*#__PURE__*/React.createElement(Divider, {
      component: "li",
      style: {
        marginLeft: '48px'
      }
...
var VcDiagnosisList$1 = withStyles(styles$1)(VcDiagnosisList);
...
var VcDiagnosisCard = function VcDiagnosisCard(props) {
  ...
  return /*#__PURE__*/React.createElement(Paper, {
  ...
  }, cardHeader)), /*#__PURE__*/React.createElement(Grid, {
    container: true,
    ...
    color: "primary"
  }, confirmedText)), /*#__PURE__*/React.createElement(Grid, {
    item: true,
    xs: 9
  }, /*#__PURE__*/React.createElement(VcDiagnosisList$1, {
  ...
  }, possibleText)), /*#__PURE__*/React.createElement(Grid, {
    item: true,
    xs: 9
  }, /*#__PURE__*/React.createElement(VcDiagnosisList$1, {
  ...
  }, /*#__PURE__*/React.createElement(VcButton$1, {
    value: addMoreText,
    color: "primary",
    squared: true,
    size: "small",
...
var index = withStyles(styles$2)(VcDiagnosisCard);
...
var VcGridColumn$1 = withStyles(styles$3)(VcGridColumn);
...
var VcGridRow$1 = withStyles(styles$4)(VcGridRow);
...
VcGrid.defaultProps = {};
var VcGrid$1 = withStyles(styles$5)(VcGrid);
...
var VcAlphaScrollList = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VcAlphaScrollList, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Paper, {
      ...
      }, /*#__PURE__*/React.createElement(VcGrid$1, null, /*#__PURE__*/React.createElement(VcGridRow$1, {
        className: cx(classes.top)
      }, /*#__PURE__*/React.createElement("div", null, this.props.title), /*#__PURE__*/React.createElement(Button, {
        className: cx(classes.xButton),
        onClick: this.props.onToggle
      }, /*#__PURE__*/React.createElement("b", null, "X"))), /*#__PURE__*/React.createElement(VcGridRow$1, {
        className: cx(classes.flexrow),
        flex: 1
      }, /*#__PURE__*/React.createElement("div", {
        className: cx(classes.vl)
      }), /*#__PURE__*/React.createElement(VcGridColumn$1, {
        ...
        }), /*#__PURE__*/React.createElement(ListItemSecondaryAction$1, {
          onClick: _this2.props.toggleSelected.bind(_this2, option)
        }, /*#__PURE__*/React.createElement("div", {
        ...
        }) ? /*#__PURE__*/React.createElement(CheckSquareIcon, {
          className: classes.checkSquare
        }) : /*#__PURE__*/React.createElement(PlusBoxIcon, {
          className: classes.plusBox
        }))));
      }) : null)), /*#__PURE__*/React.createElement("div", {
        className: classes.vlright
      })), /*#__PURE__*/React.createElement(VcGridRow$1, {
...
var index$1 = withStyles(styles$6)(VcAlphaScrollList);
...
var VcVisitSummaryCard = /*#__PURE__*/function (_React$Component) {
  ...
  function VcVisitSummaryCard(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderTimelineEvent", function (timelineEvent) {
      ...
      }, timelineEvent.timeStamp)), /*#__PURE__*/React.createElement(Grid, {
        item: true,
        xs: 8
      }, /*#__PURE__*/React.createElement(Typography, {
        className: _this.props.classes.timelineText
      }, timelineEvent.message)))), /*#__PURE__*/React.createElement(Divider, {
        component: "li",
        className: _this.props.classes.divider
      }));
    });

    _this.timelineList = /*#__PURE__*/React.createRef();
    return _this;
  }
  ...
  _createClass(VcVisitSummaryCard, [{
    ...
    value: function render() {
      return /*#__PURE__*/React.createElement(Paper, {
      ...
      }, this.props.cardHeader)), /*#__PURE__*/React.createElement(Grid, {
        container: true,
        ...
        item: true,
        xs: 12
      }, /*#__PURE__*/React.createElement(RootRef, {
        rootRef: this.timelineList
      }, /*#__PURE__*/React.createElement(List, {
        className: cx(this.props.classes.timeline, this.props.className)
      }, this.props.timeline.map(this.renderTimelineEvent)))))), this.props.onEndVisit !== undefined ? /*#__PURE__*/React.createElement(Grid, {
        container: true,
        justify: "flex-end",
...
var index$2 = withStyles(styles$7)(VcVisitSummaryCard);
...
var VcSearchButton = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VcSearchButton, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement(Manager, null, open ? /*#__PURE__*/React.createElement(Popper, {
        eventsEnabled: open
      }, function (_ref) {
        var ref = _ref.ref,
            style = _ref.style,
      ...
      }) : null, /*#__PURE__*/React.createElement(Reference, null, function (_ref2) {
        var ref = _ref2.ref;
        return /*#__PURE__*/React.createElement("div", {
          ref: ref
...
var index$3 = withStyles(styles$8)(VcSearchButton);
...
var VcCardexWindow = function VcCardexWindow(props) {
  ...
  return /*#__PURE__*/React.createElement(Paper, {
    ...
    className: cx(classes.xButton),
    onClick: onClose
  }, /*#__PURE__*/React.createElement("b", null, "X"))), rows.map(function (row, index) {
    return /*#__PURE__*/React.createElement(VcGridRow$1, {
      key: index,
      className: cx(classes.flexrow),
      flex: 1
    }, /*#__PURE__*/React.createElement("div", {
    ...
    return /*#__PURE__*/React.createElement(VcButton$1, {
...
var index$4 = withStyles(styles$9)(VcCardexWindow);
...
var VcCardexTabs = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(VcCardexTabs, [{
    ...
    value: function render() {
      ...
      }, /*#__PURE__*/React.createElement("b", null, this.props.tabLabels[0])), /*#__PURE__*/React.createElement(Button, {
        className: this.state.activeTab === 2 ? cx(classes.activeTab) : cx(classes.xButton),
        onClick: this.onToggle.bind(this, 2)
      }, /*#__PURE__*/React.createElement("b", null, this.props.tabLabels[1])), /*#__PURE__*/React.createElement(Button, {
        className: this.state.activeTab === 3 ? cx(classes.activeTab) : cx(classes.xButton),
        onClick: this.onToggle.bind(this, 3)
      }, /*#__PURE__*/React.createElement("b", null, this.props.tabLabels[2])), /*#__PURE__*/React.createElement("hr", {
        size: "5",
        className: cx(classes.line)
      })), /*#__PURE__*/React.createElement("div", {
        className: cx(classes.notes)
      }, data.map(function (row) {
        return row.type === 'Nurse' && _this2.state.activeTab === 1 || row.type === 'Doctor' && _this2.state.activeTab === 2 || _this2.state.activeTab === 3 ? /*#__PURE__*/React.createElement(VcGridRow$1, {
          className: cx(classes.rowWithBorder, row.type === 'Doctor' ? classes.doctorNotes : null),
          flex: 1,
          key: row.notesValues
        }, /*#__PURE__*/React.createElement(VcGridColumn$1, null, row.timeDisplay), /*#__PURE__*/React.createElement(VcGridColumn$1, {
          flex: 5
        }, row.notesValue), row.hasEdit && _this2.state.activeTab !== 3 ? /*#__PURE__*/React.createElement("div", {
          onClick: _this2.props.onEditRow.bind(_this2, row)
        }, /*#__PURE__*/React.createElement(Typography, null, /*#__PURE__*/React.createElement(Link$1, {
          className: classes.link
        }, _this2.props.editButtonLabel))) : null) : null;
      })), this.state.activeTab < 3 ? /*#__PURE__*/React.createElement(VcGridRow$1, {
        className: cx(classes.flexrow)
      }, this.props.editTabs ? this.props.editTabs.map(function (component, index) {
        return /*#__PURE__*/React.createElement(VcGridColumn$1, {
          className: cx(classes.papers),
...
var index$5 = withStyles(styles$a)(VcCardexTabs);
...
var VcCardexNotes = function VcCardexNotes(props) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    className: cx(classes.background, className)
  }, /*#__PURE__*/React.createElement(VcGrid$1, null, props.label ? /*#__PURE__*/React.createElement(VcGridRow$1, {
...
var index$6 = withStyles(styles$b)(VcCardexNotes);
...
var getParentMenuIcon = function getParentMenuIcon(status) {
  switch (status) {
    case MENU_STATUS.COMPLETED:
      return /*#__PURE__*/React.createElement(CheckCircle, null);

    case MENU_STATUS.STARTED:
      return /*#__PURE__*/React.createElement(MoreHorizIcon, null);

    default:
      return /*#__PURE__*/React.createElement(BlankIcon, null);
  }
};
...
var VcPatientMenu = function VcPatientMenu(props) {
  ...
  var _useState = useState(initialMenuState),
  ...
  var getMenuIcon = function getMenuIcon(status, isChild) {
    switch (status) {
      case MENU_STATUS.COMPLETED:
        return isChild ? /*#__PURE__*/React.createElement(ListItemIcon$1, {
        ...
        }, /*#__PURE__*/React.createElement(CheckCircleOutlined, null));

      case MENU_STATUS.STARTED:
        return /*#__PURE__*/React.createElement(ListItemIcon$1, {
          className: classes.menuIconStarted
        }, isChild ? /*#__PURE__*/React.createElement(DotIcon, {
          r: 0.5,
          className: classes.menuIconChild
  ...
  var renderSubMenu = function renderSubMenu(subMenus) {
    return /*#__PURE__*/React.createElement(List$1, {
      ...
      }, getMenuIcon(menu.status, true)), /*#__PURE__*/React.createElement(ListItemText$1, {
  ...
  var renderMenuItem = function renderMenuItem(menu) {
    ...
    return childrenMenu && childrenMenu.length ? /*#__PURE__*/React.createElement(React.Fragment, {
      key: display
    ...
    }, status ? getParentMenuIcon(status) : getParentMenuIcon(getParentStatus(childrenMenu))), /*#__PURE__*/React.createElement(ListItemText$1, {
      primary: display,
      disableTypography: true
    }), isOpen(display) ? /*#__PURE__*/React.createElement(ExpandLess, null) : /*#__PURE__*/React.createElement(ExpandMore, null)), /*#__PURE__*/React.createElement(Collapse, {
      "in": isOpen(display),
      timeout: "auto",
      unmountOnExit: true
    }, renderSubMenu(childrenMenu))) : /*#__PURE__*/React.createElement(ListItem$1, {
      button: true,
      classes: {
        button: classes.menuItemButton
      },
    ...
    }, getMenuIcon(status, false), /*#__PURE__*/React.createElement(ListItemText$1, {
      primary: display,
      primaryTypographyProps: {
        color: 'primary'
      }
  ...
  return /*#__PURE__*/React.createElement(List$1, {
    component: "nav",
    className: classes.root
  }, menus.map(renderMenuItem), /*#__PURE__*/React.createElement("div", {
...
var index$7 = withStyles(styles$c)(VcPatientMenu);
...
var vcCardex = function vcCardex(props) {
  ...
  }, " ", visitStatus), /*#__PURE__*/React.createElement("div", {
    className: classes.notes
  }, allNotes), /*#__PURE__*/React.createElement("div", {
...
var index$8 = withStyles(styles$d)(vcCardex);
...
var index$9 = withStyles(styles$e)(VcTimeInput);
...
function VcNotificationContent(props) {
  ...
  return /*#__PURE__*/React.createElement(SnackbarContent, _extends({
    ...
    action: onClose ? [/*#__PURE__*/React.createElement(IconButton$1, {
      key: "close",
      "aria-label": "Close",
      color: "inherit",
...
var VcNotificationContentWrapper = withStyles$1(styles$f)(VcNotificationContent);
/**
...
var VcNotification = function VcNotification(props) {
  ...
  return /*#__PURE__*/React.createElement(Snackbar, {
    ...
    onClose: onClose
  }, /*#__PURE__*/React.createElement(VcNotificationContentWrapper, _extends({
    onClose: onClose,
    variant: variant,
    message: message
  }, other)));
...
export { DeleteIcon, DiagnosisIcon, index$1 as VcAlphaScrollList, VcButton$1 as VcButton, index$8 as VcCardex, index$6 as VcCardexNotes, index$5 as VcCardexTabs, index$4 as VcCardexWindow, index as VcDiagnosisCard, VcDiagnosisList$1 as VcDiagnosisList, VcNotification, index$7 as VcPatientMenu, index$3 as VcSearchButton, index$9 as VcTimeInput, index$2 as VcVisitSummaryCard };
